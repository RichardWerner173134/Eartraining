...
public enum ChordType {
    ...
    DOMINANT_NINTH_FLAT_NINTH(Arrays.asList(ROOT, NATURAL_THIRD, FIFTH, FLAT_SEVENTH, FLAT_SECOND)),
    DOMINANT_NINTH_SHARP_NINTH(Arrays.asList(ROOT, NATURAL_THIRD, FIFTH, FLAT_SEVENTH, SHARP_SECOND)),

    DOMINANT_ELEVENTH_SHARP_ELEVEN(Arrays.asList(ROOT, NATURAL_THIRD, FIFTH, FLAT_SEVENTH, SHARP_SECOND, SHARP_FOURTH));
